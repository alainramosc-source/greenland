...
const PRODUCT_DATA = {
  ...
  'stone': {
    ...
    tagline: 'Dos líneas de revestimiento pétreo decorativo: la Piedra Flexible se fabrica con polvo de piedra natural comprimido, es ultra delgada (2-3 mm), se dobla como una lámina y se corta con tijeras. El PU Stone es un panel de poliuretano de alta densidad con textura 3D realista de piedra apilada, roca y cantera. Ambos son ultra ligeros, ignífugos, impermeables y aptos para interior y exterior.',
    color: '#8C7B6B',
    ...
    gallery: [
      ...
      { src: '/deco/stone/exterior.png', title: 'Muro Exterior', desc: 'PU Stone en jardín y paisajismo' },
    ],
    specs: [
      { label: 'Material (Flexible)', value: 'Polvo de piedra natural + arena comprimida' },
      { label: 'Material (PU Stone)', value: 'Poliuretano de alta densidad (PU Foam)' },
      { label: 'Peso (Flexible)', value: '~3 kg / pieza' },
      { label: 'Tamaño (Flexible)', value: '600×1200 mm / 600×2400 mm' },
      { label: 'Tamaño (PU Stone)', value: '1200×600 / 1500×750 / 1160×300 mm' },
      { label: 'Espesor (Flexible)', value: '2 – 3 mm' },
      { label: 'Espesor (PU Stone)', value: '1.6 – 8 cm según modelo' },
      { label: 'Resistencia', value: 'UV, humedad, fuego (B1), -20°C a 120°C' },
    ...
    advantages: [
      ...
      { icon: 'sun', title: 'Interior y exterior', desc: 'Resistente a UV, humedad y temperaturas extremas (-20°C a 120°C).' },
      ...
      { icon: 'paintbrush', title: 'Variedad de texturas', desc: 'Travertino, granito, pizarra, roca, piedra apilada, ladrillo y más.' },
    ],
    profileImages: [
      '/deco/stone/flexible.png',
    ],
    applications: [
      { src: '/deco/stone/living.png', label: 'Muros de acento interiores' },
      { src: '/deco/stone/exterior.png', label: 'Fachadas y jardines' },
