...
const PRODUCT_DATA = {
  ...
  'spc-flooring': {
    ...
    tagline: 'Piso de compuesto de piedra caliza y PVC con sistema de instalación click. 100% impermeable, ultra duro y dimensionalmente estable. Patrones realistas de madera y piedra con capa de desgaste de alto tráfico. La alternativa premium a pisos de madera, laminados y cerámicos para áreas residenciales y comerciales.',
    color: '#8E7A5C',
    heroImage: '/deco/spc-flooring.png',
    gallery: [
      { src: '/deco/spc-flooring.png', title: 'Piso SPC', desc: 'Acabado madera con sistema click', large: true },
    ],
    specs: [
      { label: 'Material', value: 'Piedra caliza + PVC (Stone Polymer Composite)' },
      { label: 'Espesor', value: '4 mm – 6 mm + underlayment IXPE' },
      { label: 'Capa de desgaste', value: '0.3 mm – 0.5 mm' },
      { label: 'Dimensiones', value: '180 × 1220 mm (estándar)' },
      { label: 'Instalación', value: 'Sistema click flotante (sin pegamento)' },
      { label: 'Impermeabilidad', value: '100% impermeable' },
      { label: 'Clasificación', value: 'AC5 / Clase 33 (alto tráfico comercial)' },
      { label: 'Estabilidad', value: 'Dimensional superior — sin expansión' },
      { label: 'Calefacción', value: 'Compatible con piso radiante' },
      { label: 'Anti-alérgico', value: 'No acumula polvo ni ácaros' },
    ],
    colorCardImage: '/deco/spc-flooring.png',
    advantages: [
      ...
      { icon: 'sparkles', title: 'Patrones realistas', desc: 'Acabados de madera y piedra con textura sincronizada y alto detalle.' },
    ...
    profileImages: [
      '/deco/spc-flooring.png',
    ],
    applications: [
      { src: '/deco/spc-flooring.png', label: 'Salas y recámaras' },
      { src: '/deco/spc-flooring.png', label: 'Cocinas y baños' },
      { src: '/deco/spc-flooring.png', label: 'Oficinas y comercios' },
    ],
  },
  'stone': {
    number: '07',
    ...
    tagline: 'Recubrimientos decorativos con apariencia de piedra natural en formato ultra ligero. La Piedra Flexible se fabrica con polvo de piedra natural comprimido: se dobla como una lámina y se adapta a superficies curvas. El PU Stone ofrece texturas tridimensionales realistas tipo ladrillo y cantera. Ambos pesan una fracción de la piedra real.',
    color: '#8C7B6B',
    heroImage: '/deco/stone.png',
    gallery: [
      { src: '/deco/stone.png', title: 'Revestimiento Pétreo', desc: 'Piedra flexible y PU Stone', large: true },
    ],
    specs: [
      { label: 'Material (Flexible)', value: 'Polvo de piedra natural comprimido' },
      { label: 'Material (PU Stone)', value: 'Poliuretano con textura 3D' },
      { label: 'Peso', value: '3 – 5 kg/m² (vs 50+ kg piedra real)' },
      { label: 'Espesor (Flexible)', value: '2 – 3 mm' },
      { label: 'Espesor (PU Stone)', value: '20 – 30 mm' },
      { label: 'Flexibilidad', value: 'Se dobla para superficies curvas' },
      ...
      { label: 'Texturas', value: 'Travertino, pizarra, ladrillo, cantera' },
    ],
    colorCardImage: '/deco/stone.png',
    advantages: [
      ...
      { icon: 'hammer', title: 'Instalación simple', desc: 'Se adhiere con adhesivo de contacto sobre cualquier superficie existente.' },
      { icon: 'sun', title: 'Interior y exterior', desc: 'Resistente a UV y humedad. Apta para fachadas, muros y jardines.' },
      { icon: 'sparkles', title: 'Textura real', desc: 'Fabricada con polvo de piedra natural. Apariencia idéntica a piedra real.' },
      { icon: 'shield', title: 'Durabilidad', desc: 'Resistente a impactos, no se agrieta ni se desprende con el tiempo.' },
      { icon: 'leaf', title: 'Ecológica', desc: 'Material sustentable fabricado sin extracción de piedra de cantera.' },
      { icon: 'paintbrush', title: 'Variedad de texturas', desc: 'Travertino, pizarra, ladrillo, cantera, arenisca y más diseños disponibles.' },
    ],
    profileImages: [
      '/deco/stone.png',
    ],
    applications: [
      { src: '/deco/stone.png', label: 'Muros de acento interiores' },
      { src: '/deco/stone.png', label: 'Fachadas exteriores' },
      { src: '/deco/stone.png', label: 'Columnas y superficies curvas' },
    ],
  },
};
