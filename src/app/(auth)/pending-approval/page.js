...
export default function PendingApprovalPage() {
    return (
        <div className="min-h-screen bg-[#f8f6f6] flex items-center justify-center relative overflow-hidden">
            {/* Background Blurs */}
            <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#6a9a04]/20 rounded-full blur-[120px] pointer-events-none" />
            ...
            <div className="w-full max-w-lg bg-white/80 backdrop-blur-xl border border-white flex flex-col items-center justify-center text-center shadow-2xl rounded-3xl p-10 relative z-10 m-4">
                ...
                <Link href="/" className="inline-flex items-center gap-2 text-sm font-bold text-white bg-[#6a9a04] px-6 py-3 rounded-xl hover:bg-[#6a9a04]/90 transition-all shadow-md">
