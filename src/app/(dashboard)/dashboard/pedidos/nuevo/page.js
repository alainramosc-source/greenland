  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-col xl:grid xl:grid-cols-[1fr_360px] gap-8 xl:h-[calc(100vh-120px)]">
        <div className="xl:overflow-y-auto xl:pr-2 pb-10 xl:pb-0">
        ...
        {/* Cart Sidebar */}
        <div className="flex flex-col bg-white/60 backdrop-blur-md border border-white/50 shadow-sm rounded-2xl overflow-hidden xl:h-[calc(100vh-160px)] xl:sticky xl:top-24">
